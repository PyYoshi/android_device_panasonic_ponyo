...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	uint32 glom = 0;
//yuhaipeng 20110712	int arpoe = 1;
//yuhaipeng 20110712	int arp_ol = 0xf;
	...
	/*yuhaipeng 20110712, disable firmware ARP offload function to 
	  move the ARP response form firmware to AP to fixed the SoftAP ping failed.*/
#if 0 
	/* Set ARP offload */
